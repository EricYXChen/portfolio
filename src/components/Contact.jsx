const socialLinks = [
  {
    href: 'https://github.com/EricYXChen',
  ...
  {
    href: 'https://www.linkedin.com/in/ericyxchen/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
                        Reach out today to talk about potential opportunities!
                    </p>
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({href, icon}, key )=> (
                            <a key = {key} href={href} target="_blank" className ="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg 
                ...
                <form action = "https://getform.io/f/avryldka" method = "POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Eric Chen" className="text-field"/>
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        <div className="">
                            ...
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="eric@example.com" className="text-field"/>
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        <div className="">
                            ...
                            <textarea name="message" id="message" placeholder="message" required className="text-field resize-y min-h-32 max-h-80"></textarea>
                        </div>
                    </div>
